...
This file only covers parts specific to the FrondEnd project
...
server running on Port 3000. For more than static HTML development make sure the server (BackEnd project) is running on
port 3000.
...
comments in the sourcecode. The documentation can be found in the `./documentation` directory and is automatically
